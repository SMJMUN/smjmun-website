...
export default function TrustSection() {
  // Double the partners array so the marquee can seamlessly loop at 50%
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-[1500px] px-4 md:px-8 lg:px-20">
        ...
        {/* Marquee Container */}
        <div className="relative mt-10 overflow-hidden marquee-mask w-full">
          <div
          ...
          >
            {marqueePartners.map((partner, index) => (
              <div key={index} className="flex shrink-0 items-center">
                <div className="flex items-center gap-3 md:gap-4 px-6 md:px-10">
                  <img
                    src={partner.logo}
                    alt={partner.name}
                    className="object-contain opacity-90"
                    style={{
                      height: '32px', // Slightly larger so the original colors pop more
                    }}
                  />
                  <span
                ...
                {/* Divider */}
                <div className="h-8 md:h-10 w-px bg-[rgba(255,255,255,0.08)]" />
              </div>
            ))}
          </div>
        </div>
