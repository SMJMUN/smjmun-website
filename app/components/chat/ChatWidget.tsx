    ...
    <>
      ...
      <div
        className={`
          ...
          bg-zinc-950 md:bg-zinc-950/95 md:backdrop-blur-xl border border-zinc-800/50 rounded-2xl shadow-2xl z-2000
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-zinc-800 bg-black/60">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="font-semibold text-sm text-zinc-100 tracking-wide">Tejas AI</h3>
