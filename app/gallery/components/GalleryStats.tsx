        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          {STATS.map((stat, i) => (
            <div key={i} className="text-center group">
              <div className="font-[family-name:var(--font-sora)] text-[clamp(40px,5vw,64px)] font-bold tracking-[-0.02em] text-navy mb-2 group-hover:text-gold transition-colors duration-500">
                {stat.value}
              </div>
